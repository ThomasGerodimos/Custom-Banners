...
function custom_banners_enqueue_styles() {
    ...
    wp_enqueue_style('custom-banners-style', $plugin_url . 'css/SD-custom-banners.css');
}
...
function create_live_post_type() {
    register_post_type('live',
        array(
			...
			'menu_icon' => 'https://staging.libre.gr/wp-content/uploads/2024/03/Live-icon_20x20.png', // Set this to the URL of your desired icon
        )
    );
}
